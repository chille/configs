...
client.connect_signal("focus", function(c)
	naughty.notify({ text = "Change focus" })
	if c.class == "Roxterm" then
		naughty.notify({ text = "Roxterm" })
		os.execute("sleep 0.1; /home/chille/configs/bin/remapkeys.sh")
		naughty.notify({ text = "Remapped" })
	else
		naughty.notify({ text = "Other window" })
		os.execute("/home/chille/configs/bin/remapkeys.sh")
		naughty.notify({ text = "Remapped" })
	end
end)
